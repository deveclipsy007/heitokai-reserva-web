...
const InvestorSection = () => {
  ...
  const shareSimulation = () => {
    ...
    navigator.clipboard.writeText(JSON.stringify(simulationData)).then(() => {
      toast({
  ...
  return <section id="investidores" className="relative py-24 overflow-hidden">
      {/* Background Elements */}
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none -z-10">
        {[...Array(6)].map((_, i) => <motion.div key={i} className="absolute rounded-full bg-heitokai-light-green/20" style={{
      ...
      <div className="container-custom relative z-10">
        ...
        <div className="mb-12">
          <PropertyGrowthVisualization investmentValue={initialInvestment} months={months} appreciationRate={appreciationRate} maxInvestment={50000} />
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-16">
          ...
          duration: 0.8
            ...
            <InvestmentCalculator initialInvestment={initialInvestment} setInitialInvestment={setInitialInvestment} months={months} setMonths={setMonths} appreciationRate={appreciationRate} setAppreciationRate={setAppreciationRate} propertyValue={propertyValue} futureValue={futureValue} formatCurrency={formatCurrency} roi={roi} />
          </motion.div>
          ...
          duration: 0.8
            ...
            <InvestmentGraphs investmentData={investmentData} breakdownData={breakdownData} chartConfig={chartConfig} formatCurrency={formatCurrency} months={months} />
          </motion.div>
        </div>
        ...
        amount: 0.2
          ...
          {statCards.map((card, index) => <motion.div key={index} variants={itemVariants} whileHover={{
          y: -5
        }} transition={{
          duration: 0.2
        }}>
                ...
                <CardContent className="pt-6">
                  <div className="flex justify-between items-start">
                    <div>
                      ...
                      <h4 className="text-3xl font-semibold text-heitokai-dark text-green-950">{card.value}</h4>
        ...
        <div className="text-center">
          ...
          duration: 0.8
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              scale: 0.95
            }} className="btn-primary group overflow-hidden relative" onClick={shareSimulation}>

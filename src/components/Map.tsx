...
const Map = () => {
  ...
  return (
    <section id="mapa" className="py-20 bg-gradient-to-b from-heitokai-beige/40 to-white/70 relative overflow-hidden">
      {/* Decorative elements */}
      <div className="absolute top-0 right-0 w-full h-full overflow-hidden pointer-events-none">
        <motion.div 
          initial={{ opacity: 0, scale: 0.8, x: "10%" }}
          animate={isVisible ? { opacity: 0.05, scale: 1, x: "0%" } : {}}
      ...
      <div className="container-custom relative z-10">
              ...
              <div className="relative h-full bg-gradient-to-br from-heitokai-dark/95 to-heitokai-green/90 text-white overflow-hidden">
                ...
                <div className="relative z-10 p-8 h-full flex flex-col justify-between" 
                  ...
                  <div className="flex items-center space-x-2 mt-4">
                    <motion.div 
                      initial={{ width: 0 }}
                      animate={isVisible ? { width: "2.5rem" } : {}}
                      transition={{ duration: 0.6, delay: 0.6 }}
                      className="h-1 bg-heitokai-light-green"
                    ></motion.div>
                    <motion.span 
                      initial={{ opacity: 0 }}
                      animate={isVisible ? { opacity: 1 } : {}}
                  ...
                  <form className="space-y-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <Input 
                        ...
                        className="border-heitokai-green/30 focus-visible:ring-heitokai-green transition-all duration-300"
                      />
                      <Input 
                        type="email" 
                        placeholder="E-mail *" 
                    ...
                    <div className="flex">
                      ...
                      <Input 
                        ...
                        className="rounded-l-none border-heitokai-green/30 focus-visible:ring-heitokai-green transition-all duration-300"
                      />
                    </div>
                    ...
                    >
                      <Button 
                        type="submit" 
                        className="w-full py-6 bg-gradient-to-r from-heitokai-green to-heitokai-dark text-white font-medium hover:shadow-lg hover:shadow-heitokai-green/20 transition-all duration-300"
                      >
        ...
        <div className="relative mt-16 h-24">
          {[...Array(10)].map((_, i) => (
            ...
            >
              <div 
                className="w-3 h-3 rounded-full bg-heitokai-green/40 blur-sm"
                style={{

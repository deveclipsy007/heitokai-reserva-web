    ...
    backgroundPosition: "center top"
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          delay: 0.8
            ...
            <div className="absolute inset-0 overflow-hidden">
              {particles.map(particle => <motion.div key={particle.key} className="absolute w-12 md:w-16 h-12 md:h-16 rounded-full bg-white/10 blur-xl" style={{
              left: particle.left,
              top: particle.top
            }} variants={particleVariants} animate="animate" transition={{
            ...
            delay: 2
              ...
              <motion.a href="#fale-conosco" className="btn-primary block md:inline-block text-center w-full md:w-auto relative group overflow-hidden" whileHover={{
              scale: 1.05,
        ...
        <div className="md:hidden w-full mt-8">
          <motion.div className="w-full h-60" initial={{
          opacity: 0,
          scale: 0.9
        }} animate={{
          opacity: 1,
      ...
      <motion.div className="absolute bottom-10 left-1/2 transform -translate-x-1/2 cursor-pointer z-20" onClick={scrollToNextSection} whileHover={{
      scale: 1.2

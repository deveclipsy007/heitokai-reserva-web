...
const Hero = () => {
  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 flex flex-col md:flex-row items-center relative z-10 mb-8">
        ...
        >
          ...
          <motion.img 
            ...
            className="absolute -left-10 top-1/2 -translate-y-1/2 w-[300px] h-[300px] object-contain z-20 rounded-lg hidden md:block" 
            initial={{
              opacity: 0,
              scale: 0.8
            }} 
      ...
      {/* Video section - side by side on desktop, below on mobile */}
      <div className="container mx-auto px-4 mt-4 mb-16">
        <div className="flex flex-col md:flex-row w-full gap-6">
          {/* On mobile, this will be full width and stack vertically */}
          {/* On desktop, this will be hidden to avoid duplication */}
          <div className="md:hidden w-full">
            ...
            >
              <div className="relative bg-white/5 backdrop-blur-md border border-white/10 h-60 w-full rounded-lg overflow-hidden shadow-2xl">
                <video 
                  autoPlay
                  muted 
                  loop 
          ...
          {/* Desktop layout - card and video side by side */}
          <motion.div 
            ...
            transition={{ duration: 0.6, delay: 0.2 }}
          >
            <div className="relative bg-white/5 backdrop-blur-md border border-white/10 h-[400px] w-full rounded-lg overflow-hidden shadow-2xl">
              <video 
                autoPlay
                muted 
                loop 

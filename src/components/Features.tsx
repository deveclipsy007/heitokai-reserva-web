...
const Features = () => {
  ...
  return <section id="sobre" className="relative py-24 overflow-hidden">
      {/* Background Elements */}
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none -z-10">
        {[...Array(8)].map((_, i) => <motion.div key={i} className="absolute rounded-full bg-heitokai-light-green/20" style={{
      ...
      <div className="container-custom relative z-10">
        ...
        duration: 1
          ...
          duration: 0.8,
          delay: 0.3
        }} className="text-center max-w-2xl text-heitokai-dark/80 mb-10">O Condomínio Reserva Rio Uru Heitoraí representa um conceito inovador de moradia que integra sofisticação e consciência ambiental, onde cada elemento foi cuidadosamente planejado para elevar sua experiência de vida em conexão com a natureza.</motion.p>
        </motion.div>
        ...
        amount: 0.2
          ...
          {featureItems.map((feature, index) => <motion.div key={index} variants={itemVariants} whileHover={{
          scale: 1.03,
          y: -5
        }} transition={{
          duration: 0.3
              ...
              <Card className="h-full overflow-hidden border border-heitokai-light-green/30 bg-white/90 backdrop-blur-sm shadow-md hover:shadow-xl transition-all duration-500">
                <CardContent className="p-6 flex flex-col items-center h-full">
                  <motion.div animate={floatingAnimation} className="text-5xl mb-6 bg-gradient-to-br from-heitokai-light-green/60 to-heitokai-green/30 p-4 rounded-full transform transition-all duration-500 group-hover:bg-gradient-to-br group-hover:from-heitokai-green/60 group-hover:to-heitokai-light-green/30">
                    {feature.icon}
                  </motion.div>
        ...
        <div className="mt-32 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          duration: 0.8
            ...
            <p className="mb-6 text-lg text-heitokai-dark/80">O Condomínio Reserva Rio Uru Heitoraí é a materialização de um sonho para quem valoriza exclusividade e contato direto com a natureza. Não é apenas um empreendimento imobiliário — é uma declaração de valores e um novo conceito de vida, onde sustentabilidade e sofisticação andam lado a lado.</p>
          ...
          duration: 1
            ...
            duration: 3
          }} alt="Vista aérea do condomínio" className="w-full h-full object-cover rounded-lg" src="/lovable-uploads/d0cd53f7-90e4-4cb9-bbef-bc2228f62cde.jpg" />
        ...
        duration: 0.8
          ...
          <p className="text-heitokai-dark/80 max-w-2xl mx-auto mb-8">Os lotes do Condomínio Reserva Rio Uru Heitoraí são limitados. Entre em contato agora mesmo e garanta sua participação neste empreendimento exclusivo.</p>
          <motion.a href="#contato" whileHover={{
          scale: 1.05
        }} whileTap={{
          scale: 0.95
